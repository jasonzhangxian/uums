...
Ext.namespace("Uums.desktop");

Ext.define("Uums.desktop.App", {
  ...
  getTaskbarConfig: function () {
    ...
    return Ext.apply(ret, {
      trayItems: [
        { xtype: 'button', id: 'btnSetting', iconCls:'settings', text: UumsLanguage.Settings, handler: function() {me.onSettings(); this.disable();} }
      ]
    });
  },
  ...
  init: function() {
    ...
    me.desktop = new Uums.desktop.Desktop(desktopCfg);
  ...
  loadModule : function(moduleId, moduleName) {
    ...
    */
    Ext.Ajax.request({
      url: Uums.CONF.LOAD_URL + '/' + moduleId,
      success: function(o){
        /*
  ...
  getDesktopSettingWindow: function() {
    var desktopSettingWindow = new Uums.settings.SettingsDialog({app: this});
