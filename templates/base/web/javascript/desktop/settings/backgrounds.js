...
Ext.define('Uums.settings.BackgroundPanel', {
  ...
  constructor: function(app) {
    ...
    view = new Ext.view.View({
      ...
      tpl: tpl,
      autoHeight:true,
      emptyText: UumsLanguage.noWallpaperText,
    ...
    var position = new Ext.Panel({
      ...
      items: [{
          border: false,
          items: {border: false, html:UumsLanguage.wallpaperPositionTitle},
          x: 15,
          y: 15
        },{
          border: false,
        ...
        {
          border: false,
          items: {border: false, html:UumsLanguage.desktopBackgroundTitle},
          x: 245,
          y: 15
        },{
          border: false,
          items: new Ext.Button({
            ...
            text: UumsLanguage.btnBackgroundColor
          }),
          x: 245,
          y: 40
        },{
          border: false,
          items: {border: false, html:UumsLanguage.fontColorTitle},
          x: 425,
          y: 15
        },{
          border: false,
          items: new Ext.Button({
            ...
            text: UumsLanguage.btnFontColor
          }),
          x: 425,
          y: 40
      }],
    ...
    config.title = UumsLanguage.WallpaperSetting;
