...
{{ include('admin_logs/admin_logs_grid.tpl')}}
{{ include('admin_logs/admin_logs_dialog.tpl')}}
{{ include('admin_logs/admin_logs_main_panel.tpl')}}

Uums.admin_logs.request_url = '/admin/admin_logs/admin_logs';
                           <!--需要改-->
