  ...
  Uums.privilege.request_url = '{{ site_url('/admin/privilege/privilege') }}';

 {{ include( 'privilege/privilege_grid.tpl' ) }};
 {{ include( 'privilege/privilege_dialog.tpl' ) }};
 {{ include( 'privilege/privilege_main_panel.tpl' ) }};
 {{ include( 'privilege/privilege_general_panel.tpl' ) }};
 {{ include( 'privilege/privilege_move_dialog.tpl' ) }};
 {{ include( 'privilege/privilege_tree_panel.tpl' ) }};
